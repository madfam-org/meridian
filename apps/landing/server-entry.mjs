 ...
 *
 * Every internal rewrite this site performs answers the visitor with a header
...
console.log(
  `meridian-landing: internal response header filter active for ${INTERNAL_RESPONSE_HEADERS.join(', ')}`,
);
