 ...
 * tooltip, not a toggle. See `lib/i18n.ts` for why this site shows both
 ...
 * The separator is decorative and hidden from assistive technology, which reads
 * the two `lang`-tagged runs as the distinct strings they are.
 */
 ...
 * language-specific but is not a `Bi` pair — the name of an instrument, for
