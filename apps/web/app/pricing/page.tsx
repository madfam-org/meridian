  ...
  return (
    <Page>
      <PageHeader
        eyebrow={
          <>
            <Chip>Pricing</Chip>
            <Chip>
              <TInline text={bi('Prices not set', 'Precios no fijados')} />
            </Chip>
          </>
        }
        title={bi(
      ...
      <Callout
        ...
        title={
          unavailableCount === 0
            ? bi('Every tier below can be obtained today', 'Todos los niveles siguientes pueden obtenerse hoy')
            : bi(
      ...
      <Section
        id="the-line"
        title={bi('Where the line falls, and why', 'Dónde cae la línea y por qué')}
        description={bi(
      ...
      <Evidence id="release-gate" />

      <Section
        id="free"
        title={bi('The free tier, listed by asking the gate', 'El nivel gratuito, enumerado preguntando al control')}
        description={bi(
      ...
      >
        <CapabilityList ids={FREE_CAPABILITY_IDS} />
        <Callout
          tone="accent"
          icon="◆"
          title={bi('No result is ever held back for an email address', 'Ningún resultado se retiene a cambio de un correo')}
        >
          <TProse
            text={bi(
      ...
      <Section
        id="tiers"
        title={bi('The tiers', 'Los niveles')}
        description={bi(
      ...
      <Section
        id="clinics"
        title={bi('Legal aid and NGO clinics: free, permanently', 'Clínicas jurídicas y ONG: gratis, de forma permanente')}
        description={bi(
      ...
      <Section
        id="no-prices"
        title={bi('Why there is no number on this page', 'Por qué en esta página no hay ninguna cifra')}
      >
        <Stack gap="md">
          <TProse
            text={bi(
