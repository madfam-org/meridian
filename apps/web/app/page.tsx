...
import { Card, Facts, Fact, Figure, Grid, Page, PageHeader, Section, Stack } from '@/components/Layout';
...
export default function HomePage() {
  return (
    <Page>
      ...
      <Section
        id="what-it-does"
        title={bi('What it does', 'Qué hace')}
        description={bi(
        ...
        <Grid>
          <Card>
            <h3 className={styles.cardTitle}>
              <T text={bi('Counts your days', 'Cuenta sus días')} />
            </h3>
            <TProse
              text={bi(
          ...
          <Card>
            <h3 className={styles.cardTitle}>
              <T text={bi('Measures you against the rules', 'Le mide frente a las normas')} />
            </h3>
            <TProse
              text={bi(
          ...
          <Card>
            <h3 className={styles.cardTitle}>
              <T text={bi('Sequences the paperwork', 'Ordena la documentación')} />
            </h3>
            <TProse
              text={bi(
          ...
          <Card>
            <h3 className={styles.cardTitle}>
              <T text={bi('Shows its sources', 'Muestra sus fuentes')} />
            </h3>
            <TProse
              text={bi(
      ...
      <Section
        id="catalog-state"
        title={bi('The state of the rule catalog', 'Estado del catálogo de normas')}
        description={bi(
        ...
        <Card tone="sunken">
          <Facts>
            <Fact label={bi('Pathways encoded', 'Vías codificadas')}>
              <Figure value={catalog.length} unit={bi('routes', 'vías')} />
            </Fact>
      ...
      <Section
        ...
        title={bi('Where the line is', 'Dónde está la línea')}
        description={bi(
      ...
      <Section
        id="built"
        title={bi('What is built, and what is not', 'Qué está construido y qué no')}
      >
        <Grid>
          <Card>
            <h3 className={styles.cardTitle}>
      ...
      <Section
        id="explore"
        title={bi('Look around', 'Eche un vistazo')}
        description={bi(
      ...
      >
        <Grid>
          ...
          <Link href="/pathways" className={styles.navCard}>
            <span className={styles.navCardTitle}>
              <T text={bi('Pathways', 'Vías')} />
            </span>
            <span className={styles.navCardBody}>
              <T
                text={bi(
